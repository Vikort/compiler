...
if: IF OPEN_BRACKET condition CLOSE_BRACKET OPEN_FIGURE_BRACKET operation* CLOSE_FIGURE_BRACKET;
else_if:ELSE IF OPEN_BRACKET condition CLOSE_BRACKET OPEN_FIGURE_BRACKET operation* CLOSE_FIGURE_BRACKET;
else:ELSE OPEN_FIGURE_BRACKET operation* CLOSE_FIGURE_BRACKET;

for_statement: FOR OPEN_BRACKET range CLOSE_BRACKET OPEN_FIGURE_BRACKET operation* CLOSE_FIGURE_BRACKET;
...
range: (TYPE|ARRAY_TYPE) VARNAME IN VARNAME;
